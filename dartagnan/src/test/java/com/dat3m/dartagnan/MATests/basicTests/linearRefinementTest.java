...
public class linearRefinementTest extends AbstractCTest {

    private String reportFileName;

    public linearRefinementTest(String name, Arch target, Result expected, String reportFileName) {
    ...
    public static Iterable<Object[]> data() throws IOException {
        ...
        String testName = "LinearRefinement";
