...
public class MassRandomEvent extends AbstractCTest {
    ...
    public MassRandomEvent(String name, Arch target, Result expected, String reportFileName, ParallelSolverConfiguration.SplittingStyle splittingStyle , int[] nAndM, long seed) {
    ...
    public static Iterable<Object[]> data() throws IOException {
        ...
        String testName = "MassRandomEvents";
    ...
    public void testParallelRefinement() throws Exception {
        ParallelSolverConfiguration parallelConfig = ParallelSolverConfigurationFactory.seededEventConfig(seed);
