...
public class RandomRFFilterTest extends AbstractCTest {

    private String reportFileName;
    private long randomSeed;
    private ParallelSolverConfiguration.SplittingObjectFilter soFilter;

    public RandomRFFilterTest(String name, Arch target, Result expected, String reportFileName, ParallelSolverConfiguration.SplittingObjectFilter soFilter, long seed) {
    ...
    public static Iterable<Object[]> data() throws IOException {
        ...
        String testName = "RandomRFFilterTests";
    ...
    public void testParallelRefinement() throws Exception {
        ParallelSolverConfiguration parallelConfig = ParallelSolverConfigurationFactory.seededRFTupleConfig(randomSeed);
