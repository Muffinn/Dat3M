...
public class RandomEventsTest extends AbstractCTest {

    private String reportFileName;
    private long randomSeed;
    private ParallelSolverConfiguration.SplittingObjectFilter soFilter;

    public RandomEventsTest(String name, Arch target, Result expected, String reportFileName, ParallelSolverConfiguration.SplittingObjectFilter soFilter) {
        super(name, target, expected);
        this.reportFileName = reportFileName;
        this.soFilter = soFilter;
        this.randomSeed = 8813662937532908859L;
    ...
    public static Iterable<Object[]> data() throws IOException {
        ...
        String testName = "RandomEventTests";
