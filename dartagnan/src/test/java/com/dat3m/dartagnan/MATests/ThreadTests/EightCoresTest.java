...
public class EightCoresTest extends AbstractCTest {

    private String reportFileName;
    private int[] nAndM;

    public EightCoresTest(String name, Arch target, Result expected, String reportFileName, int[] nAndM) {
    ...
    public static Iterable<Object[]> data() throws IOException {
        ...
        String testName = "EightCoresTest";

        String[] programNames = {"dglm-3", "ms-3", "treiber-3"};
        Arch[] wmms = {TSO, ARM8, C11};


        int[][] nAndMArray = {{1,1}, {2,1}, {2,2}, {3,2}, {2,3}};
    ...
    public void testParallelRefinement() throws Exception {
        ...
        parallelConfig.setMaxNumberOfConcurrentThreads(8);
