...
public class MassRandomRFTest extends AbstractCTest {
    ...
    public MassRandomRFTest(String name, Arch target, Result expected, String reportFileName, ParallelSolverConfiguration.SplittingStyle splittingStyle , int[] nAndM, long seed) {
    ...
    public void testParallelRefinement() throws Exception {
        ParallelSolverConfiguration parallelConfig = ParallelSolverConfigurationFactory.seededRFTupleConfig(seed);
